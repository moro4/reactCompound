...
import { BsViewStacked, Pie, Button, SparkLine, Stacked } from '../components';
      ...
      <div className='mt-12'>
         ...
         <div className='flex flex-wrap lg:flex-nowrap justify-center'>
            ...
            <div className='bg-white dark:text-gray-200
               dark:bg-secondary-dark h-44 rounded-xl w-full lg:w-80 p-8
            ...
            >
               ...
               <div className='flex justify-between items-center'>
                  <div>
                     ...
                     <p className='text-2xl'>$63,448.09</p>
                  </div>
               </div>
         ...
         <div className='flex gap-10 flex-wrap justify-center'>
            <div className='bg-white dark:text-gray-200
               dark:bg-secondary-dark m-3 p-4 rounded-2xl md:w-780'
            >
               ...
               <div className='mt-10 flex gap-10 flex-wrap justify-center'>
                  <div className='border-r-1 border-color m-4 pr-10'>
                     ...
                     <div>
                        <p>
                           <span className='align-middle text-3xl font-semibold'>
                              $93,438
                           </span>
